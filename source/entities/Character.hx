...
class Character extends FlxExtendedSprite {
	...
	private var thisSpeed:Float = 120;
	private var thisJump:Float = 200;
	...
	public function new(Name:String, X:Float = 0, Y:Float = 0, ?JsonPath:String, ?SimpleGraphic:Dynamic) {
		...
		this.maxVelocity.set(thisSpeed, 420);
		this.drag.set(thisSpeed * 4, thisSpeed * 4);
	}
